...
const VotingPage = () => {
  ...
  const handleSubmitIdea = async (e: React.FormEvent) => {
    ...
    if (!username.trim() || !selectedIdeaName.trim()) {
      toast({
        title: "Error",
        description: "Please fill in both username and select an idea.",
        variant: "destructive",
      });
      return;
    }
            ...
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
              ...
              <SheetContent>
                ...
                <form onSubmit={handleSubmitIdea} className="space-y-4 mt-6">
                  ...
                  <div>
                    <Select value={selectedIdeaName} onValueChange={setSelectedIdeaName}>
